...
public class Periodos {
	...
	public static void cadastrarPeriodos() {
		...
		do {
			...
			System.out.println("---------------------");
			System.out.println("# Novo Perído Sendo Criado...\n");
			...
			System.out.println("  O Período " + preenchePeriodo.horaInicio + ":" 
							               + preenchePeriodo.minutosInicio + " até " 
							               + preenchePeriodo.horaTermino + ":" 
							               + preenchePeriodo.minutosTermino + " na "
							               + preenchePeriodo.diaDaSemana + ", Criado!\n");
			
			opcao = JOptionPane.showConfirmDialog(null, "Quer continuar criando periodos ?", "Escolha um",
	...
	public static void listarPeriodos() {
		...
		if(listaSegunda.size() == 0 && listaTerca.size() == 0 &&
		   listaQuarta.size() == 0 && listaQuinta.size() == 0 &&
		   listaTerca.size() == 0 && listaSabado.size() == 0) {
		
			System.out.println("---------------------");
			System.out.println("LISTA DE PERÍODOS:\n");
			
			System.out.println("# Não existe períodos cadastrados.\n");
			System.out.println("# Por Favor, crie um novo Período.\n");
